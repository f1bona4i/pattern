...
\lstdefinestyle{mystyle}{
    ...
    stringstyle=\color{codepurple},       % Стиль строк
    basicstyle=\ttfamily\footnotesize,    % Базовый стиль
    breakatwhitespace=false,              % Разрывать только на пробелах?
    breaklines=true,                      % Разрывать длинные строки
...
% Применение нашего стиля
\lstset{style=mystyle}

% Настройка поддержки кириллицы в листингах
\lstset{
    literate=%
